...
NSString *OAuthorizationHeaderWithCallback(NSURL *url, NSString *method, NSData *body, NSString *_oAuthConsumerKey, NSString *_oAuthConsumerSecret, NSString *_oAuthToken, NSString *_oAuthTokenSecret, NSString *_oAuthCallback) {
	return OAuthorizationHeaderWithCallbackAndVerifier(url,method,body,_oAuthConsumerKey,_oAuthConsumerSecret,_oAuthToken,_oAuthTokenSecret,_oAuthCallback,nil);
}

NSString *OAuthorizationHeaderWithCallbackAndVerifier(NSURL *url, NSString *method, NSData *body, NSString *_oAuthConsumerKey, NSString *_oAuthConsumerSecret, NSString *_oAuthToken, NSString *_oAuthTokenSecret, NSString *_oAuthCallback, NSString *_oAuthVerifier) {
